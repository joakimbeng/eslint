...
module.exports = function(context) {
    ...
    var options = context.options[0] || {},
        ...
        beforeColon = Number(options.beforeColon || false),  // Defaults to 0
        afterColon = Number(options.afterColon || options.afterColon !== 0 && options.afterColon !== false);  // Defaults to 1
